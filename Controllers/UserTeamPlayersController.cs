...
namespace BasketballWebApp.Controllers
{
    public class UserTeamPlayersController : Controller
    {
        ...
        public UserTeamPlayersController(BasketballProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var basketballProjectContext = _context.UserTeamPlayers.Include(u => u.Player).Include(u => u.UserTeam);
        ...
        // GET: UserTeamPlayers/Create
        public IActionResult Create()
        {
            ViewData["PlayerId"] = new SelectList(_context.Players, "PlayerId", "FirstName");
            ViewData["UserTeamId"] = new SelectList(_context.UserTeams, "UserTeamId", "TeamName");
            return View();
        }
